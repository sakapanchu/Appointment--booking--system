    ...
    return (
      <div className='w-full max-w-6xl m-5'>
          ...
          <div className='bg-white rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
                 <div className='hiddden sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col py-3 px-6'>    
                     <p>#</p>
                     <p>Patient</p>
                     <p>Age</p>
                     <p>Date & Time</p>
                 ...
                 {appointments.map((item, index)=> (
                     <div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6  hover:bg-gray-100' key={index}>  
